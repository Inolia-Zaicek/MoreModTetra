...
import static com.inolia_zaicek.more_mod_tetra.Effect.EffectGuiStats.armor_revival_Effect;
...
public class ArmorHealAndRevival {
    ...
    public static void hurt(LivingHurtEvent event) {
        ...
        //固定
        float fixedValue = MMTEffectHelper.getInstance().getAllArmorSumEffectLevel(livingEntity, armor_revival_Effect);
        if (percentage > 0 || fixedValue > 0) {
            livingEntity.heal(fixedValue+livingEntity.getMaxHealth()*percentage/100);
        }
    }
}
