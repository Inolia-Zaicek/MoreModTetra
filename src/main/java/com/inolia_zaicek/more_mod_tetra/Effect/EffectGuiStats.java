...
public class EffectGuiStats {
    ...
    public static final ItemEffect bokushuuSDesireEffect = ItemEffect.get(MoreModTetra.MODID + ":bokushuu_s_desire");
    public static final String bokushuuSDesireName = MoreModTetra.MODID + ".effect.bokushuu_s_desire.name";
    public static final String bokushuuSDesireTooltip = MoreModTetra.MODID + ".effect.bokushuu_s_desire.tooltip";

    public static final ItemEffect standTallEffect = ItemEffect.get(MoreModTetra.MODID + ":stand_tall");
    public static final String standTallName = MoreModTetra.MODID + ".effect.stand_tall.name";
    public static final String standTallTooltip = MoreModTetra.MODID + ".effect.stand_tall.tooltip";
    ...
    public static final ItemEffect manaRepairEffect = ItemEffect.get(MoreModTetra.MODID + ":mana_repair");
    public static final String manaRepairName = MoreModTetra.MODID + ".effect.mana_repair.name";
    public static final String manaRepairTooltip = MoreModTetra.MODID + ".effect.mana_repair.tooltip";
    ...
    public static final ItemEffect curiosNightVisionEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_night_vision");
    public static final String curiosNightVisionName = MoreModTetra.MODID + ".effect.curios_night_vision.name";
    public static final String curiosNightVisionTooltip = MoreModTetra.MODID + ".effect.curios_night_vision.tooltip";

    public static final ItemEffect curiosFireResistanceEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_fire_resistance");
    public static final String curiosFireResistanceName = MoreModTetra.MODID + ".effect.curios_fire_resistance.name";
    public static final String curiosFireResistanceTooltip = MoreModTetra.MODID + ".effect.curios_fire_resistance.tooltip";

    public static final ItemEffect curiosHealthBoostEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_health_boost");
    public static final String curiosHealthBoostName = MoreModTetra.MODID + ".effect.curios_health_boost.name";
    public static final String curiosHealthBoostTooltip = MoreModTetra.MODID + ".effect.curios_health_boost.tooltip";

    public static final ItemEffect curiosWaterBreathingEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_water_breathing");
    public static final String curiosWaterBreathingName = MoreModTetra.MODID + ".effect.curios_water_breathing.name";
    public static final String curiosWaterBreathingTooltip = MoreModTetra.MODID + ".effect.curios_water_breathing.tooltip";

    public static final ItemEffect curiosJumpBoostEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_jump_boost");
    public static final String curiosJumpBoostName = MoreModTetra.MODID + ".effect.curios_jump_boost.name";
    public static final String curiosJumpBoostTooltip = MoreModTetra.MODID + ".effect.curios_jump_boost.tooltip";

    public static final ItemEffect curiosHeroOfTheVillageEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_hero_of_the_village");
    public static final String curiosHeroOfTheVillageName = MoreModTetra.MODID + ".effect.curios_hero_of_the_village.name";
    public static final String curiosHeroOfTheVillageTooltip = MoreModTetra.MODID + ".effect.curios_hero_of_the_village.tooltip";

    public static final ItemEffect curiosSaturationEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_saturation");
    public static final String curiosSaturationName = MoreModTetra.MODID + ".effect.curios_saturation.name";
    public static final String curiosSaturationTooltip = MoreModTetra.MODID + ".effect.curios_saturation.tooltip";

    public static final ItemEffect curiosLuckEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_luck");
    public static final String curiosLuckName = MoreModTetra.MODID + ".effect.curios_luck.name";
    public static final String curiosLuckTooltip = MoreModTetra.MODID + ".effect.curios_luck.tooltip";

    public static final ItemEffect curiosHasteEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_haste");
    public static final String curiosHasteName = MoreModTetra.MODID + ".effect.curios_haste.name";
    public static final String curiosHasteTooltip = MoreModTetra.MODID + ".effect.curios_haste.tooltip";

    public static final ItemEffect curiosResistanceEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_resistance");
    public static final String curiosResistanceName = MoreModTetra.MODID + ".effect.curios_resistance.name";
    public static final String curiosResistanceTooltip = MoreModTetra.MODID + ".effect.curios_resistance.tooltip";

    public static final ItemEffect curiosStrengthEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_strength");
    public static final String curiosStrengthName = MoreModTetra.MODID + ".effect.curios_strength.name";
    public static final String curiosStrengthTooltip = MoreModTetra.MODID + ".effect.curios_strength.tooltip";

    public static final ItemEffect curiosRegenerationEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_regeneration");
    public static final String curiosRegenerationName = MoreModTetra.MODID + ".effect.curios_regeneration.name";
    public static final String curiosRegenerationTooltip = MoreModTetra.MODID + ".effect.curios_regeneration.tooltip";

    public static final ItemEffect curiosSpeedEffect = ItemEffect.get(MoreModTetra.MODID + ":curios_speed");
    public static final String curiosSpeedName = MoreModTetra.MODID + ".effect.curios_speed.name";
    public static final String curiosSpeedTooltip = MoreModTetra.MODID + ".effect.curios_speed.tooltip";
    ...
    public static final ItemEffect fieryPalpitationEffect = ItemEffect.get(MoreModTetra.MODID + ":fiery_palpitation");
    public static final String fieryPalpitationName = MoreModTetra.MODID + ".effect.fiery_palpitation.name";
    public static final String fieryPalpitationTooltip = MoreModTetra.MODID + ".effect.fiery_palpitation.tooltip";
    //水月
    ...
    public static final ItemEffect odeToPassageEffect = ItemEffect.get(MoreModTetra.MODID + ":ode_to_passage");
    public static final String odeToPassageName = MoreModTetra.MODID + ".effect.ode_to_passage.name";
    public static final String odeToPassageTooltip = MoreModTetra.MODID + ".effect.ode_to_passage.tooltip";

    public static final ItemEffect odeToTrailblazeEffect = ItemEffect.get(MoreModTetra.MODID + ":ode_to_trailblaze");
    public static final String odeToTrailblazeName = MoreModTetra.MODID + ".effect.ode_to_trailblaze.name";
    public static final String odeToTrailblazeTooltip = MoreModTetra.MODID + ".effect.ode_to_trailblaze.tooltip";

    public static final ItemEffect odeToCyreneEffect = ItemEffect.get(MoreModTetra.MODID + ":ode_to_cyrene");
    public static final String odeToCyreneName = MoreModTetra.MODID + ".effect.ode_to_cyrene.name";
    public static final String odeToCyreneTooltip = MoreModTetra.MODID + ".effect.ode_to_cyrene.tooltip";

    public static final ItemEffect fantasy_arcane_edgeEffect = ItemEffect.get(MoreModTetra.MODID + ":fantasy_arcane_edge");
    public static final String fantasy_arcane_edgeName = MoreModTetra.MODID + ".effect.fantasy_arcane_edge.name";
    public static final String fantasy_arcane_edgeTooltip = MoreModTetra.MODID + ".effect.fantasy_arcane_edge.tooltip";

    public static final ItemEffect fantasy_devourEffect = ItemEffect.get(MoreModTetra.MODID + ":fantasy_devour");
    public static final String fantasy_devourName = MoreModTetra.MODID + ".effect.fantasy_devour.name";
    public static final String fantasy_devourTooltip = MoreModTetra.MODID + ".effect.fantasy_devour.tooltip";

    public static final ItemEffect fantasy_traceEffect = ItemEffect.get(MoreModTetra.MODID + ":fantasy_trace");
    public static final String fantasy_traceName = MoreModTetra.MODID + ".effect.fantasy_trace.name";
    public static final String fantasy_traceTooltip = MoreModTetra.MODID + ".effect.fantasy_trace.tooltip";

    public static final ItemEffect fantasy_shadowEffect = ItemEffect.get(MoreModTetra.MODID + ":fantasy_shadow");
    public static final String fantasy_shadowName = MoreModTetra.MODID + ".effect.fantasy_shadow.name";
    public static final String fantasy_shadowTooltip = MoreModTetra.MODID + ".effect.fantasy_shadow.tooltip";

    public static final ItemEffect diamond_guard_Effect = ItemEffect.get(MoreModTetra.MODID + ":diamond_guard");
    public static final String diamond_guard_Name = MoreModTetra.MODID + ".effect.diamond_guard.name";
    public static final String diamond_guard_Tooltip = MoreModTetra.MODID + ".effect.diamond_guard.tooltip";

    public static final ItemEffect ignitium_suit_Effect = ItemEffect.get(MoreModTetra.MODID + ":ignitium_suit");
    public static final String ignitium_suit_Name = MoreModTetra.MODID + ".effect.ignitium_suit.name";
    public static final String ignitium_suit_Tooltip = MoreModTetra.MODID + ".effect.ignitium_suit.tooltip";

    public static final ItemEffect cursium_head_Effect = ItemEffect.get(MoreModTetra.MODID + ":cursium_head");
    public static final String cursium_head_Name = MoreModTetra.MODID + ".effect.cursium_head.name";
    public static final String cursium_head_Tooltip = MoreModTetra.MODID + ".effect.cursium_head.tooltip";

    public static final ItemEffect cursium_chest_Effect = ItemEffect.get(MoreModTetra.MODID + ":cursium_chest");
    public static final String cursium_chest_Name = MoreModTetra.MODID + ".effect.cursium_chest.name";
    public static final String cursium_chest_Tooltip = MoreModTetra.MODID + ".effect.cursium_chest.tooltip";

    public static final ItemEffect cursium_legs_Effect = ItemEffect.get(MoreModTetra.MODID + ":cursium_legs");
    public static final String cursium_legs_Name = MoreModTetra.MODID + ".effect.cursium_legs.name";
    public static final String cursium_legs_Tooltip = MoreModTetra.MODID + ".effect.cursium_legs.tooltip";

    public static final ItemEffect cursium_feet_Effect = ItemEffect.get(MoreModTetra.MODID + ":cursium_feet");
    public static final String cursium_feet_Name = MoreModTetra.MODID + ".effect.cursium_feet.name";
    public static final String cursium_feet_Tooltip = MoreModTetra.MODID + ".effect.cursium_feet.tooltip";

    public static final ItemEffect eeeabsmobs_erode_effect_Effect = ItemEffect.get(MoreModTetra.MODID + ":eeeabsmobs_erode_effect");
    public static final String eeeabsmobs_erode_effect_Name = MoreModTetra.MODID + ".effect.eeeabsmobs_erode_effect.name";
    public static final String eeeabsmobs_erode_effect_Tooltip = MoreModTetra.MODID + ".effect.eeeabsmobs_erode_effect.tooltip";

    public static final ItemEffect eeeabsmobs_frenzy_effect_Effect = ItemEffect.get(MoreModTetra.MODID + ":eeeabsmobs_frenzy_effect");
    public static final String eeeabsmobs_frenzy_effect_Name = MoreModTetra.MODID + ".effect.eeeabsmobs_frenzy_effect.name";
    public static final String eeeabsmobs_frenzy_effect_Tooltip = MoreModTetra.MODID + ".effect.eeeabsmobs_frenzy_effect.tooltip";

    public static final ItemEffect melee_attack_combo_Effect = ItemEffect.get(MoreModTetra.MODID + ":melee_attack_combo");
    public static final String melee_attack_combo_Name = MoreModTetra.MODID + ".effect.melee_attack_combo.name";
    public static final String melee_attack_combo_Tooltip = MoreModTetra.MODID + ".effect.melee_attack_combo.tooltip";

    public static final ItemEffect armor_critical_strike_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_critical_strike");
    public static final String armor_critical_strike_Name = MoreModTetra.MODID + ".effect.armor_critical_strike.name";
    public static final String armor_critical_strike_Tooltip = MoreModTetra.MODID + ".effect.armor_critical_strike.tooltip";

    public static final ItemEffect armor_sturdy_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_sturdy");
    public static final String armor_sturdy_Name = MoreModTetra.MODID + ".effect.armor_sturdy.name";
    public static final String armor_sturdy_Tooltip = MoreModTetra.MODID + ".effect.armor_sturdy.tooltip";

    public static final ItemEffect armor_tenacity_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_tenacity");
    public static final String armor_tenacity_Name = MoreModTetra.MODID + ".effect.armor_tenacity.name";
    public static final String armor_tenacity_Tooltip = MoreModTetra.MODID + ".effect.armor_tenacity.tooltip";

    public static final ItemEffect armor_revival_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_revival");
    public static final String armor_revival_Name = MoreModTetra.MODID + ".effect.armor_revival.name";
    public static final String armor_revival_Tooltip = MoreModTetra.MODID + ".effect.armor_revival.tooltip";

    public static final ItemEffect armor_heal_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_heal");
    public static final String armor_heal_Name = MoreModTetra.MODID + ".effect.armor_heal.name";
    public static final String armor_heal_Tooltip = MoreModTetra.MODID + ".effect.armor_heal.tooltip";

    public static final ItemEffect undead_protection_Effect = ItemEffect.get(MoreModTetra.MODID + ":undead_protection");
    public static final String undead_protection_Name = MoreModTetra.MODID + ".effect.undead_protection.name";
    public static final String undead_protection_Tooltip = MoreModTetra.MODID + ".effect.undead_protection.tooltip";

    public static final ItemEffect arthropods_protection_Effect = ItemEffect.get(MoreModTetra.MODID + ":arthropods_protection");
    public static final String arthropods_protection_Name = MoreModTetra.MODID + ".effect.arthropods_protection.name";
    public static final String arthropods_protection_Tooltip = MoreModTetra.MODID + ".effect.arthropods_protection.tooltip";

    public static final ItemEffect armor_last_stand_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_last_stand");
    public static final String armor_last_stand_Name = MoreModTetra.MODID + ".effect.armor_last_stand.name";
    public static final String armor_last_stand_Tooltip = MoreModTetra.MODID + ".effect.armor_last_stand.tooltip";

    public static final ItemEffect armor_final_stand_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_final_stand");
    public static final String armor_final_stand_Name = MoreModTetra.MODID + ".effect.armor_final_stand.name";
    public static final String armor_final_stand_Tooltip = MoreModTetra.MODID + ".effect.armor_final_stand.tooltip";

    public static final ItemEffect armor_complete_form_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_complete_form");
    public static final String armor_complete_form_Name = MoreModTetra.MODID + ".effect.armor_complete_form.name";
    public static final String armor_complete_form_Tooltip = MoreModTetra.MODID + ".effect.armor_complete_form.tooltip";

    public static final ItemEffect armor_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":armor_thorns");
    public static final String armor_thorns_Name = MoreModTetra.MODID + ".effect.armor_thorns.name";
    public static final String armor_thorns_Tooltip = MoreModTetra.MODID + ".effect.armor_thorns.tooltip";

    public static final ItemEffect magic_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":magic_thorns");
    public static final String magic_thorns_Name = MoreModTetra.MODID + ".effect.magic_thorns.name";
    public static final String magic_thorns_Tooltip = MoreModTetra.MODID + ".effect.magic_thorns.tooltip";

    public static final ItemEffect lightning_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":lightning_thorns");
    public static final String lightning_thorns_Name = MoreModTetra.MODID + ".effect.lightning_thorns.name";
    public static final String lightning_thorns_Tooltip = MoreModTetra.MODID + ".effect.lightning_thorns.tooltip";

    public static final ItemEffect fire_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":fire_thorns");
    public static final String fire_thorns_Name = MoreModTetra.MODID + ".effect.fire_thorns.name";
    public static final String fire_thorns_Tooltip = MoreModTetra.MODID + ".effect.fire_thorns.tooltip";

    public static final ItemEffect freeze_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":freeze_thorns");
    public static final String freeze_thorns_Name = MoreModTetra.MODID + ".effect.freeze_thorns.name";
    public static final String freeze_thorns_Tooltip = MoreModTetra.MODID + ".effect.freeze_thorns.tooltip";

    public static final ItemEffect wither_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":wither_thorns");
    public static final String wither_thorns_Name = MoreModTetra.MODID + ".effect.wither_thorns.name";
    public static final String wither_thorns_Tooltip = MoreModTetra.MODID + ".effect.wither_thorns.tooltip";

    public static final ItemEffect dragon_breath_thorns_Effect = ItemEffect.get(MoreModTetra.MODID + ":dragon_breath_thorns");
    ...
    public static final ItemEffect flawless_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":flawless_attack");
    public static final String flawless_attack_Name = MoreModTetra.MODID + ".effect.flawless_attack.name";
    public static final String flawless_attack_Tooltip = MoreModTetra.MODID + ".effect.flawless_attack.tooltip";

    public static final ItemEffect universe_power_Effect = ItemEffect.get(MoreModTetra.MODID + ":universe_power");
    public static final String universe_power_Name = MoreModTetra.MODID + ".effect.universe_power.name";
    public static final String universe_power_Tooltip = MoreModTetra.MODID + ".effect.universe_power.tooltip";

    public static final ItemEffect born_in_chaos_v1_soul_stratification_Effect = ItemEffect.get(MoreModTetra.MODID + ":born_in_chaos_v1_soul_stratification");
    public static final String born_in_chaos_v1_soul_stratification_Name = MoreModTetra.MODID + ".effect.born_in_chaos_v1_soul_stratification.name";
    public static final String born_in_chaos_v1_soul_stratification_Tooltip = MoreModTetra.MODID + ".effect.born_in_chaos_v1_soul_stratification.tooltip";

    public static final ItemEffect ride_skill_Effect = ItemEffect.get(MoreModTetra.MODID + ":ride_skill");
    public static final String ride_skill_Name = MoreModTetra.MODID + ".effect.ride_skill.name";
    public static final String ride_skill_Tooltip = MoreModTetra.MODID + ".effect.ride_skill.tooltip";

    public static final ItemEffect legendary_monsters_soul_rage_Effect = ItemEffect.get(MoreModTetra.MODID + ":legendary_monsters_soul_rage");
    public static final String legendary_monsters_soul_rage_Name = MoreModTetra.MODID + ".effect.legendary_monsters_soul_rage.name";
    public static final String legendary_monsters_soul_rage_Tooltip = MoreModTetra.MODID + ".effect.legendary_monsters_soul_rage.tooltip";

    public static final ItemEffect dolphins_grace_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":dolphins_grace_buff");
    public static final String dolphins_grace_buff_Name = MoreModTetra.MODID + ".effect.dolphins_grace_buff.name";
    public static final String dolphins_grace_buff_Tooltip = MoreModTetra.MODID + ".effect.dolphins_grace_buff.tooltip";

    public static final ItemEffect saturation_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":saturation_buff");
    public static final String saturation_buff_Name = MoreModTetra.MODID + ".effect.saturation_buff.name";
    public static final String saturation_buff_Tooltip = MoreModTetra.MODID + ".effect.saturation_buff.tooltip";

    public static final ItemEffect hero_of_the_village_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":hero_of_the_village_buff");
    public static final String hero_of_the_village_buff_Name = MoreModTetra.MODID + ".effect.hero_of_the_village_buff.name";
    public static final String hero_of_the_village_buff_Tooltip = MoreModTetra.MODID + ".effect.hero_of_the_village_buff.tooltip";

    public static final ItemEffect luck_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":luck_buff");
    public static final String luck_buff_Name = MoreModTetra.MODID + ".effect.luck_buff.name";
    public static final String luck_buff_Tooltip = MoreModTetra.MODID + ".effect.luck_buff.tooltip";

    public static final ItemEffect speed_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":speed_buff");
    public static final String speed_buff_Name = MoreModTetra.MODID + ".effect.speed_buff.name";
    public static final String speed_buff_Tooltip = MoreModTetra.MODID + ".effect.speed_buff.tooltip";

    public static final ItemEffect fire_resistance_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":fire_resistance_buff");
    public static final String fire_resistance_buff_Name = MoreModTetra.MODID + ".effect.fire_resistance_buff.name";
    public static final String fire_resistance_buff_Tooltip = MoreModTetra.MODID + ".effect.fire_resistance_buff.tooltip";

    public static final ItemEffect slow_falling_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":slow_falling_buff");
    public static final String slow_falling_buff_Name = MoreModTetra.MODID + ".effect.slow_falling_buff.name";
    public static final String slow_falling_buff_Tooltip = MoreModTetra.MODID + ".effect.slow_falling_buff.tooltip";

    public static final ItemEffect haste_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":haste_buff");
    public static final String haste_buff_Name = MoreModTetra.MODID + ".effect.haste_buff.name";
    public static final String haste_buff_Tooltip = MoreModTetra.MODID + ".effect.haste_buff.tooltip";

    public static final ItemEffect resistance_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":resistance_buff");
    public static final String resistance_buff_Name = MoreModTetra.MODID + ".effect.resistance_buff.name";
    public static final String resistance_buff_Tooltip = MoreModTetra.MODID + ".effect.resistance_buff.tooltip";

    public static final ItemEffect strength_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":strength_buff");
    public static final String strength_buff_Name = MoreModTetra.MODID + ".effect.strength_buff.name";
    public static final String strength_buff_Tooltip = MoreModTetra.MODID + ".effect.strength_buff.tooltip";

    public static final ItemEffect regeneration_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":regeneration_buff");
    public static final String regeneration_buff_Name = MoreModTetra.MODID + ".effect.regeneration_buff.name";
    public static final String regeneration_buff_Tooltip = MoreModTetra.MODID + ".effect.regeneration_buff.tooltip";

    public static final ItemEffect invisibility_buff_Effect = ItemEffect.get(MoreModTetra.MODID + ":invisibility_buff");
    ...
    public static final ItemEffect youkaishomecoming_unconscious_Effect = ItemEffect.get(MoreModTetra.MODID + ":youkaishomecoming_unconscious");
    public static final String youkaishomecoming_unconscious_Name = MoreModTetra.MODID + ".effect.youkaishomecoming_unconscious.name";
    public static final String youkaishomecoming_unconscious_Tooltip = MoreModTetra.MODID + ".effect.youkaishomecoming_unconscious.tooltip";

    public static final ItemEffect curios_youkaishomecoming_unconscious_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_youkaishomecoming_unconscious");
    public static final String curios_youkaishomecoming_unconscious_Name = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_unconscious.name";
    public static final String curios_youkaishomecoming_unconscious_Tooltip = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_unconscious.tooltip";
    ...
    public static final ItemEffect goety_plunge_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":goety_plunge_clear");
    public static final String goety_plunge_clear_Name = MoreModTetra.MODID + ".effect.goety_plunge_clear.name";
    public static final String goety_plunge_clear_Tooltip = MoreModTetra.MODID + ".effect.goety_plunge_clear.tooltip";

    public static final ItemEffect curios_goety_plunge_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_goety_plunge_clear");
    public static final String curios_goety_plunge_clear_Name = MoreModTetra.MODID + ".effect.curios_goety_plunge_clear.name";
    public static final String curios_goety_plunge_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_goety_plunge_clear.tooltip";

    public static final ItemEffect goety_crippled_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":goety_crippled_clear");
    public static final String goety_crippled_clear_Name = MoreModTetra.MODID + ".effect.goety_crippled_clear.name";
    public static final String goety_crippled_clear_Tooltip = MoreModTetra.MODID + ".effect.goety_crippled_clear.tooltip";

    public static final ItemEffect curios_goety_crippled_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_goety_crippled_clear");
    public static final String curios_goety_crippled_clear_Name = MoreModTetra.MODID + ".effect.curios_goety_crippled_clear.name";
    public static final String curios_goety_crippled_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_goety_crippled_clear.tooltip";

    public static final ItemEffect chapter_of_yuusha_3_core_voidification_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":chapter_of_yuusha_3_core_voidification_clear");
    public static final String chapter_of_yuusha_3_core_voidification_clear_Name = MoreModTetra.MODID + ".effect.chapter_of_yuusha_3_core_voidification_clear.name";
    public static final String chapter_of_yuusha_3_core_voidification_clear_Tooltip = MoreModTetra.MODID + ".effect.chapter_of_yuusha_3_core_voidification_clear.tooltip";

    public static final ItemEffect curios_chapter_of_yuusha_3_core_voidification_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_chapter_of_yuusha_3_core_voidification_clear");
    public static final String curios_chapter_of_yuusha_3_core_voidification_clear_Name = MoreModTetra.MODID + ".effect.curios_chapter_of_yuusha_3_core_voidification_clear.name";
    public static final String curios_chapter_of_yuusha_3_core_voidification_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_chapter_of_yuusha_3_core_voidification_clear.tooltip";
    ...
    public static final ItemEffect goety_doom_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":goety_doom_clear");
    public static final String goety_doom_clear_Name = MoreModTetra.MODID + ".effect.goety_doom_clear.name";
    public static final String goety_doom_clear_Tooltip = MoreModTetra.MODID + ".effect.goety_doom_clear.tooltip";

    public static final ItemEffect curios_goety_doom_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_goety_doom_clear");
    public static final String curios_goety_doom_clear_Name = MoreModTetra.MODID + ".effect.curios_goety_doom_clear.name";
    public static final String curios_goety_doom_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_goety_doom_clear.tooltip";

    public static final ItemEffect alexscaves_magnetizing_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexscaves_magnetizing_clear");
    public static final String alexscaves_magnetizing_clear_Name = MoreModTetra.MODID + ".effect.alexscaves_magnetizing_clear.name";
    public static final String alexscaves_magnetizing_clear_Tooltip = MoreModTetra.MODID + ".effect.alexscaves_magnetizing_clear.tooltip";

    public static final ItemEffect curios_alexscaves_magnetizing_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexscaves_magnetizing_clear");
    public static final String curios_alexscaves_magnetizing_clear_Name = MoreModTetra.MODID + ".effect.curios_alexscaves_magnetizing_clear.name";
    public static final String curios_alexscaves_magnetizing_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_alexscaves_magnetizing_clear.tooltip";

    public static final ItemEffect alexscaves_irradiated_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexscaves_irradiated_clear");
    public static final String alexscaves_irradiated_clear_Name = MoreModTetra.MODID + ".effect.alexscaves_irradiated_clear.name";
    public static final String alexscaves_irradiated_clear_Tooltip = MoreModTetra.MODID + ".effect.alexscaves_irradiated_clear.tooltip";

    public static final ItemEffect curios_alexscaves_irradiated_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexscaves_irradiated_clear");
    public static final String curios_alexscaves_irradiated_clear_Name = MoreModTetra.MODID + ".effect.curios_alexscaves_irradiated_clear.name";
    public static final String curios_alexscaves_irradiated_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_alexscaves_irradiated_clear.tooltip";

    public static final ItemEffect aether_inebriation_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":aether_inebriation_clear");
    public static final String aether_inebriation_clear_Name = MoreModTetra.MODID + ".effect.aether_inebriation_clear.name";
    public static final String aether_inebriation_clear_Tooltip = MoreModTetra.MODID + ".effect.aether_inebriation_clear.tooltip";

    public static final ItemEffect curios_aether_inebriation_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_aether_inebriation_clear");
    public static final String curios_aether_inebriation_clear_Name = MoreModTetra.MODID + ".effect.curios_aether_inebriation_clear.name";
    public static final String curios_aether_inebriation_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_aether_inebriation_clear.tooltip";

    public static final ItemEffect cataclysm_blazing_brand_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":cataclysm_blazing_brand_clear");
    public static final String cataclysm_blazing_brand_clear_Name = MoreModTetra.MODID + ".effect.cataclysm_blazing_brand_clear.name";
    public static final String cataclysm_blazing_brand_clear_Tooltip = MoreModTetra.MODID + ".effect.cataclysm_blazing_brand_clear.tooltip";

    public static final ItemEffect curios_cataclysm_blazing_brand_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_cataclysm_blazing_brand_clear");
    public static final String curios_cataclysm_blazing_brand_clear_Name = MoreModTetra.MODID + ".effect.curios_cataclysm_blazing_brand_clear.name";
    public static final String curios_cataclysm_blazing_brand_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_cataclysm_blazing_brand_clear.tooltip";

    public static final ItemEffect cataclysm_curse_of_desert_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":cataclysm_curse_of_desert_clear");
    public static final String cataclysm_curse_of_desert_clear_Name = MoreModTetra.MODID + ".effect.cataclysm_curse_of_desert_clear.name";
    public static final String cataclysm_curse_of_desert_clear_Tooltip = MoreModTetra.MODID + ".effect.cataclysm_curse_of_desert_clear.tooltip";

    public static final ItemEffect curios_cataclysm_curse_of_desert_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_cataclysm_curse_of_desert_clear");
    public static final String curios_cataclysm_curse_of_desert_clear_Name = MoreModTetra.MODID + ".effect.curios_cataclysm_curse_of_desert_clear.name";
    public static final String curios_cataclysm_curse_of_desert_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_cataclysm_curse_of_desert_clear.tooltip";

    public static final ItemEffect born_in_chaos_v1_bone_fracture_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":born_in_chaos_v1_bone_fracture_clear");
    public static final String born_in_chaos_v1_bone_fracture_clear_Name = MoreModTetra.MODID + ".effect.born_in_chaos_v1_bone_fracture_clear.name";
    public static final String born_in_chaos_v1_bone_fracture_clear_Tooltip = MoreModTetra.MODID + ".effect.born_in_chaos_v1_bone_fracture_clear.tooltip";

    public static final ItemEffect curios_born_in_chaos_v1_bone_fracture_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_born_in_chaos_v1_bone_fracture_clear");
    public static final String curios_born_in_chaos_v1_bone_fracture_clear_Name = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_bone_fracture_clear.name";
    public static final String curios_born_in_chaos_v1_bone_fracture_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_bone_fracture_clear.tooltip";

    public static final ItemEffect born_in_chaos_v1_intoxicating_decoction_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":born_in_chaos_v1_intoxicating_decoction_clear");
    public static final String born_in_chaos_v1_intoxicating_decoction_clear_Name = MoreModTetra.MODID + ".effect.born_in_chaos_v1_intoxicating_decoction_clear.name";
    public static final String born_in_chaos_v1_intoxicating_decoction_clear_Tooltip = MoreModTetra.MODID + ".effect.born_in_chaos_v1_intoxicating_decoction_clear.tooltip";

    public static final ItemEffect curios_born_in_chaos_v1_intoxicating_decoction_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_born_in_chaos_v1_intoxicating_decoction_clear");
    public static final String curios_born_in_chaos_v1_intoxicating_decoction_clear_Name = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_intoxicating_decoction_clear.name";
    public static final String curios_born_in_chaos_v1_intoxicating_decoction_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_intoxicating_decoction_clear.tooltip";

    public static final ItemEffect born_in_chaos_v1_magic_depletion_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":born_in_chaos_v1_magic_depletion_clear");
    public static final String born_in_chaos_v1_magic_depletion_clear_Name = MoreModTetra.MODID + ".effect.born_in_chaos_v1_magic_depletion_clear.name";
    public static final String born_in_chaos_v1_magic_depletion_clear_Tooltip = MoreModTetra.MODID + ".effect.born_in_chaos_v1_magic_depletion_clear.tooltip";

    public static final ItemEffect curios_born_in_chaos_v1_magic_depletion_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_born_in_chaos_v1_magic_depletion_clear");
    public static final String curios_born_in_chaos_v1_magic_depletion_clear_Name = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_magic_depletion_clear.name";
    public static final String curios_born_in_chaos_v1_magic_depletion_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_magic_depletion_clear.tooltip";

    public static final ItemEffect born_in_chaos_v1_myiasis_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":born_in_chaos_v1_myiasis_clear");
    public static final String born_in_chaos_v1_myiasis_clear_Name = MoreModTetra.MODID + ".effect.born_in_chaos_v1_myiasis_clear.name";
    public static final String born_in_chaos_v1_myiasis_clear_Tooltip = MoreModTetra.MODID + ".effect.born_in_chaos_v1_myiasis_clear.tooltip";

    public static final ItemEffect curios_born_in_chaos_v1_myiasis_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_born_in_chaos_v1_myiasis_clear");
    public static final String curios_born_in_chaos_v1_myiasis_clear_Name = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_myiasis_clear.name";
    public static final String curios_born_in_chaos_v1_myiasis_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_myiasis_clear.tooltip";

    public static final ItemEffect born_in_chaos_v1_rotten_smell_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":born_in_chaos_v1_rotten_smell_clear");
    public static final String born_in_chaos_v1_rotten_smell_clear_Name = MoreModTetra.MODID + ".effect.born_in_chaos_v1_rotten_smell_clear.name";
    public static final String born_in_chaos_v1_rotten_smell_clear_Tooltip = MoreModTetra.MODID + ".effect.born_in_chaos_v1_rotten_smell_clear.tooltip";

    public static final ItemEffect curios_born_in_chaos_v1_rotten_smell_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_born_in_chaos_v1_rotten_smell_clear");
    public static final String curios_born_in_chaos_v1_rotten_smell_clear_Name = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_rotten_smell_clear.name";
    public static final String curios_born_in_chaos_v1_rotten_smell_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_born_in_chaos_v1_rotten_smell_clear.tooltip";

    public static final ItemEffect quark_resilience_Effect = ItemEffect.get(MoreModTetra.MODID + ":quark_resilience");
    public static final String quark_resilience_Name = MoreModTetra.MODID + ".effect.quark_resilience.name";
    public static final String quark_resilience_Tooltip = MoreModTetra.MODID + ".effect.quark_resilience.tooltip";

    public static final ItemEffect curios_quark_resilience_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_quark_resilience");
    public static final String curios_quark_resilience_Name = MoreModTetra.MODID + ".effect.curios_quark_resilience.name";
    public static final String curios_quark_resilience_Tooltip = MoreModTetra.MODID + ".effect.curios_quark_resilience.tooltip";

    public static final ItemEffect alexsmobs_bug_pheromones_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexsmobs_bug_pheromones");
    public static final String alexsmobs_bug_pheromones_Name = MoreModTetra.MODID + ".effect.alexsmobs_bug_pheromones.name";
    public static final String alexsmobs_bug_pheromones_Tooltip = MoreModTetra.MODID + ".effect.alexsmobs_bug_pheromones.tooltip";

    public static final ItemEffect curios_alexsmobs_bug_pheromones_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexsmobs_bug_pheromones");
    public static final String curios_alexsmobs_bug_pheromones_Name = MoreModTetra.MODID + ".effect.curios_alexsmobs_bug_pheromones.name";
    public static final String curios_alexsmobs_bug_pheromones_Tooltip = MoreModTetra.MODID + ".effect.curios_alexsmobs_bug_pheromones.tooltip";

    public static final ItemEffect alexsmobs_mosquito_repellent_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexsmobs_mosquito_repellent");
    public static final String alexsmobs_mosquito_repellent_Name = MoreModTetra.MODID + ".effect.alexsmobs_mosquito_repellent.name";
    public static final String alexsmobs_mosquito_repellent_Tooltip = MoreModTetra.MODID + ".effect.alexsmobs_mosquito_repellent.tooltip";

    public static final ItemEffect curios_alexsmobs_mosquito_repellent_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexsmobs_mosquito_repellent");
    public static final String curios_alexsmobs_mosquito_repellent_Name = MoreModTetra.MODID + ".effect.curios_alexsmobs_mosquito_repellent.name";
    public static final String curios_alexsmobs_mosquito_repellent_Tooltip = MoreModTetra.MODID + ".effect.curios_alexsmobs_mosquito_repellent.tooltip";

    public static final ItemEffect alexsmobs_clinging_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexsmobs_clinging");
    public static final String alexsmobs_clinging_Name = MoreModTetra.MODID + ".effect.alexsmobs_clinging.name";
    public static final String alexsmobs_clinging_Tooltip = MoreModTetra.MODID + ".effect.alexsmobs_clinging.tooltip";

    public static final ItemEffect curios_alexsmobs_clinging_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexsmobs_clinging");
    public static final String curios_alexsmobs_clinging_Name = MoreModTetra.MODID + ".effect.curios_alexsmobs_clinging.name";
    public static final String curios_alexsmobs_clinging_Tooltip = MoreModTetra.MODID + ".effect.curios_alexsmobs_clinging.tooltip";

    public static final ItemEffect alexsmobs_knockback_resistance_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexsmobs_knockback_resistance");
    public static final String alexsmobs_knockback_resistance_Name = MoreModTetra.MODID + ".effect.alexsmobs_knockback_resistance.name";
    public static final String alexsmobs_knockback_resistance_Tooltip = MoreModTetra.MODID + ".effect.alexsmobs_knockback_resistance.tooltip";

    public static final ItemEffect curios_alexsmobs_knockback_resistance_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexsmobs_knockback_resistance");
    public static final String curios_alexsmobs_knockback_resistance_Name = MoreModTetra.MODID + ".effect.curios_alexsmobs_knockback_resistance.name";
    public static final String curios_alexsmobs_knockback_resistance_Tooltip = MoreModTetra.MODID + ".effect.curios_alexsmobs_knockback_resistance.tooltip";

    public static final ItemEffect alexsmobs_soulsteal_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexsmobs_soulsteal");
    public static final String alexsmobs_soulsteal_Name = MoreModTetra.MODID + ".effect.alexsmobs_soulsteal.name";
    public static final String alexsmobs_soulsteal_Tooltip = MoreModTetra.MODID + ".effect.alexsmobs_soulsteal.tooltip";

    public static final ItemEffect curios_alexsmobs_soulsteal_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexsmobs_soulsteal");
    public static final String curios_alexsmobs_soulsteal_Name = MoreModTetra.MODID + ".effect.curios_alexsmobs_soulsteal.name";
    public static final String curios_alexsmobs_soulsteal_Tooltip = MoreModTetra.MODID + ".effect.curios_alexsmobs_soulsteal.tooltip";

    public static final ItemEffect alexscaves_deepsight_Effect = ItemEffect.get(MoreModTetra.MODID + ":alexscaves_deepsight");
    public static final String alexscaves_deepsight_Name = MoreModTetra.MODID + ".effect.alexscaves_deepsight.name";
    public static final String alexscaves_deepsight_Tooltip = MoreModTetra.MODID + ".effect.alexscaves_deepsight.tooltip";

    public static final ItemEffect curios_alexscaves_deepsight_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_alexscaves_deepsight");
    public static final String curios_alexscaves_deepsight_Name = MoreModTetra.MODID + ".effect.curios_alexscaves_deepsight.name";
    public static final String curios_alexscaves_deepsight_Tooltip = MoreModTetra.MODID + ".effect.curios_alexscaves_deepsight.tooltip";

    public static final ItemEffect cataclysm_blessing_of_amethyst_Effect = ItemEffect.get(MoreModTetra.MODID + ":cataclysm_blessing_of_amethyst");
    public static final String cataclysm_blessing_of_amethyst_Name = MoreModTetra.MODID + ".effect.cataclysm_blessing_of_amethyst.name";
    public static final String cataclysm_blessing_of_amethyst_Tooltip = MoreModTetra.MODID + ".effect.cataclysm_blessing_of_amethyst.tooltip";

    public static final ItemEffect curios_cataclysm_blessing_of_amethyst_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_cataclysm_blessing_of_amethyst");
    public static final String curios_cataclysm_blessing_of_amethyst_Name = MoreModTetra.MODID + ".effect.curios_cataclysm_blessing_of_amethyst.name";
    public static final String curios_cataclysm_blessing_of_amethyst_Tooltip = MoreModTetra.MODID + ".effect.curios_cataclysm_blessing_of_amethyst.tooltip";

    public static final ItemEffect goety_soul_cost_discount_Effect = ItemEffect.get(MoreModTetra.MODID + ":goety_soul_cost_discount");
    public static final String goety_soul_cost_discount_Name = MoreModTetra.MODID + ".effect.goety_soul_cost_discount.name";
    public static final String goety_soul_cost_discount_Tooltip = MoreModTetra.MODID + ".effect.goety_soul_cost_discount.tooltip";

    public static final ItemEffect curios_goety_soul_cost_discount_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_goety_soul_cost_discount");
    public static final String curios_goety_soul_cost_discount_Name = MoreModTetra.MODID + ".effect.curios_goety_soul_cost_discount.name";
    public static final String curios_goety_soul_cost_discount_Tooltip = MoreModTetra.MODID + ".effect.curios_goety_soul_cost_discount.tooltip";

    public static final ItemEffect goety_soul_focus_potency_Effect = ItemEffect.get(MoreModTetra.MODID + ":goety_soul_focus_potency");
    public static final String goety_soul_focus_potency_Name = MoreModTetra.MODID + ".effect.goety_soul_focus_potency.name";
    public static final String goety_soul_focus_potency_Tooltip = MoreModTetra.MODID + ".effect.goety_soul_focus_potency.tooltip";

    public static final ItemEffect curios_goety_soul_focus_potency_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_goety_soul_focus_potency");
    public static final String curios_goety_soul_focus_potency_Name = MoreModTetra.MODID + ".effect.curios_goety_soul_focus_potency.name";
    public static final String curios_goety_soul_focus_potency_Tooltip = MoreModTetra.MODID + ".effect.curios_goety_soul_focus_potency.tooltip";

    public static final ItemEffect goety_soul_spell_cooldown_Effect = ItemEffect.get(MoreModTetra.MODID + ":goety_soul_spell_cooldown");
    public static final String goety_soul_spell_cooldown_Name = MoreModTetra.MODID + ".effect.goety_soul_spell_cooldown.name";
    public static final String goety_soul_spell_cooldown_Tooltip = MoreModTetra.MODID + ".effect.goety_soul_spell_cooldown.tooltip";

    public static final ItemEffect curios_goety_soul_spell_cooldown_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_goety_soul_spell_cooldown");
    public static final String curios_goety_soul_spell_cooldown_Name = MoreModTetra.MODID + ".effect.curios_goety_soul_spell_cooldown.name";
    public static final String curios_goety_soul_spell_cooldown_Tooltip = MoreModTetra.MODID + ".effect.curios_goety_soul_spell_cooldown.tooltip";

    public static final ItemEffect orders_Effect = ItemEffect.get(MoreModTetra.MODID + ":orders");
    public static final String orders_Name = MoreModTetra.MODID + ".effect.orders.name";
    public static final String orders_Tooltip = MoreModTetra.MODID + ".effect.orders.tooltip";

    public static final ItemEffect youkaishomecoming_caffeinated_Effect = ItemEffect.get(MoreModTetra.MODID + ":youkaishomecoming_caffeinated");
    public static final String youkaishomecoming_caffeinated_Name = MoreModTetra.MODID + ".effect.youkaishomecoming_caffeinated.name";
    public static final String youkaishomecoming_caffeinated_Tooltip = MoreModTetra.MODID + ".effect.youkaishomecoming_caffeinated.tooltip";

    public static final ItemEffect curios_youkaishomecoming_caffeinated_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_youkaishomecoming_caffeinated");
    public static final String curios_youkaishomecoming_caffeinated_Name = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_caffeinated.name";
    public static final String curios_youkaishomecoming_caffeinated_Tooltip = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_caffeinated.tooltip";

    public static final ItemEffect youkaishomecoming_tea_polyphenols_Effect = ItemEffect.get(MoreModTetra.MODID + ":youkaishomecoming_tea_polyphenols");
    public static final String youkaishomecoming_tea_polyphenols_Name = MoreModTetra.MODID + ".effect.youkaishomecoming_tea_polyphenols.name";
    public static final String youkaishomecoming_tea_polyphenols_Tooltip = MoreModTetra.MODID + ".effect.youkaishomecoming_tea_polyphenols.tooltip";

    public static final ItemEffect curios_youkaishomecoming_tea_polyphenols_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_youkaishomecoming_tea_polyphenols");
    public static final String curios_youkaishomecoming_tea_polyphenols_Name = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_tea_polyphenols.name";
    public static final String curios_youkaishomecoming_tea_polyphenols_Tooltip = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_tea_polyphenols.tooltip";

    public static final ItemEffect youkaishomecoming_youkaified_Effect = ItemEffect.get(MoreModTetra.MODID + ":youkaishomecoming_youkaified");
    public static final String youkaishomecoming_youkaified_Name = MoreModTetra.MODID + ".effect.youkaishomecoming_youkaified.name";
    public static final String youkaishomecoming_youkaified_Tooltip = MoreModTetra.MODID + ".effect.youkaishomecoming_youkaified.tooltip";

    public static final ItemEffect curios_youkaishomecoming_youkaified_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_youkaishomecoming_youkaified");
    public static final String curios_youkaishomecoming_youkaified_Name = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_youkaified.name";
    public static final String curios_youkaishomecoming_youkaified_Tooltip = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_youkaified.tooltip";

    public static final ItemEffect youkaishomecoming_youkaifying_Effect = ItemEffect.get(MoreModTetra.MODID + ":youkaishomecoming_youkaifying");
    public static final String youkaishomecoming_youkaifying_Name = MoreModTetra.MODID + ".effect.youkaishomecoming_youkaifying.name";
    public static final String youkaishomecoming_youkaifying_Tooltip = MoreModTetra.MODID + ".effect.youkaishomecoming_youkaifying.tooltip";

    public static final ItemEffect curios_youkaishomecoming_youkaifying_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_youkaishomecoming_youkaifying");
    public static final String curios_youkaishomecoming_youkaifying_Name = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_youkaifying.name";
    public static final String curios_youkaishomecoming_youkaifying_Tooltip = MoreModTetra.MODID + ".effect.curios_youkaishomecoming_youkaifying.tooltip";

    public static final ItemEffect apotheosis_grievous_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":apotheosis_grievous_clear");
    public static final String apotheosis_grievous_clear_Name = MoreModTetra.MODID + ".effect.apotheosis_grievous_clear.name";
    public static final String apotheosis_grievous_clear_Tooltip = MoreModTetra.MODID + ".effect.apotheosis_grievous_clear.tooltip";

    public static final ItemEffect curios_apotheosis_grievous_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_apotheosis_grievous_clear");
    public static final String curios_apotheosis_grievous_clear_Name = MoreModTetra.MODID + ".effect.curios_apotheosis_grievous_clear.name";
    public static final String curios_apotheosis_grievous_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_apotheosis_grievous_clear.tooltip";

    public static final ItemEffect apotheosis_bleeding_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":apotheosis_bleeding_clear");
    public static final String apotheosis_bleeding_clear_Name = MoreModTetra.MODID + ".effect.apotheosis_bleeding_clear.name";
    public static final String apotheosis_bleeding_clear_Tooltip = MoreModTetra.MODID + ".effect.apotheosis_bleeding_clear.tooltip";

    public static final ItemEffect curios_apotheosis_bleeding_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_apotheosis_bleeding_clear");
    public static final String curios_apotheosis_bleeding_clear_Name = MoreModTetra.MODID + ".effect.curios_apotheosis_bleeding_clear.name";
    public static final String curios_apotheosis_bleeding_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_apotheosis_bleeding_clear.tooltip";

    public static final ItemEffect apotheosis_sundering_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":apotheosis_sundering_clear");
    public static final String apotheosis_sundering_clear_Name = MoreModTetra.MODID + ".effect.apotheosis_sundering_clear.name";
    public static final String apotheosis_sundering_clear_Tooltip = MoreModTetra.MODID + ".effect.apotheosis_sundering_clear.tooltip";

    public static final ItemEffect curios_apotheosis_sundering_clear_Effect = ItemEffect.get(MoreModTetra.MODID + ":curios_apotheosis_sundering_clear");
    public static final String curios_apotheosis_sundering_clear_Name = MoreModTetra.MODID + ".effect.curios_apotheosis_sundering_clear.name";
    public static final String curios_apotheosis_sundering_clear_Tooltip = MoreModTetra.MODID + ".effect.curios_apotheosis_sundering_clear.tooltip";

    public static final ItemEffect white_minecraft_weakness_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_weakness_attack");
    public static final String white_minecraft_weakness_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_weakness_attack.name";
    public static final String white_minecraft_weakness_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_weakness_attack.tooltip";

    public static final ItemEffect white_scabbard_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_scabbard");
    public static final String white_scabbard_Name = MoreModTetra.MODID + ".effect.white_scabbard.name";
    public static final String white_scabbard_Tooltip = MoreModTetra.MODID + ".effect.white_scabbard.tooltip";

    public static final ItemEffect white_quiver_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_quiver");
    public static final String white_quiver_Name = MoreModTetra.MODID + ".effect.white_quiver.name";
    public static final String white_quiver_Tooltip = MoreModTetra.MODID + ".effect.white_quiver.tooltip";

    public static final ItemEffect white_bag_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_bag");
    public static final String white_bag_Name = MoreModTetra.MODID + ".effect.white_bag.name";
    public static final String white_bag_Tooltip = MoreModTetra.MODID + ".effect.white_bag.tooltip";

    public static final ItemEffect white_goety_cursed_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_cursed_attack");
    public static final String white_goety_cursed_attack_Name = MoreModTetra.MODID + ".effect.white_goety_cursed_attack.name";
    public static final String white_goety_cursed_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_cursed_attack.tooltip";

    public static final ItemEffect white_minecraft_poison_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_poison_attack");
    public static final String white_minecraft_poison_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_poison_attack.name";
    public static final String white_minecraft_poison_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_poison_attack.tooltip";

    public static final ItemEffect white_minecraft_levitation_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_levitation_attack");
    public static final String white_minecraft_levitation_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_levitation_attack.name";
    public static final String white_minecraft_levitation_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_levitation_attack.tooltip";

    public static final ItemEffect white_minecraft_slowness_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_slowness_attack");
    public static final String white_minecraft_slowness_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_slowness_attack.name";
    public static final String white_minecraft_slowness_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_slowness_attack.tooltip";

    public static final ItemEffect white_minecraft_wither_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_wither_attack");
    public static final String white_minecraft_wither_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_wither_attack.name";
    public static final String white_minecraft_wither_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_wither_attack.tooltip";

    public static final ItemEffect white_minecraft_glowing_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_glowing_attack");
    public static final String white_minecraft_glowing_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_glowing_attack.name";
    public static final String white_minecraft_glowing_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_glowing_attack.tooltip";

    public static final ItemEffect white_minecraft_blindness_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_minecraft_blindness_attack");
    public static final String white_minecraft_blindness_attack_Name = MoreModTetra.MODID + ".effect.white_minecraft_blindness_attack.name";
    public static final String white_minecraft_blindness_attack_Tooltip = MoreModTetra.MODID + ".effect.white_minecraft_blindness_attack.tooltip";

    public static final ItemEffect white_goety_freezing_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_freezing_attack");
    public static final String white_goety_freezing_attack_Name = MoreModTetra.MODID + ".effect.white_goety_freezing_attack.name";
    public static final String white_goety_freezing_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_freezing_attack.tooltip";

    public static final ItemEffect white_goety_sapped_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_sapped_attack");
    public static final String white_goety_sapped_attack_Name = MoreModTetra.MODID + ".effect.white_goety_sapped_attack.name";
    public static final String white_goety_sapped_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_sapped_attack.tooltip";

    public static final ItemEffect white_goety_wane_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_wane_attack");
    public static final String white_goety_wane_attack_Name = MoreModTetra.MODID + ".effect.white_goety_wane_attack.name";
    public static final String white_goety_wane_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_wane_attack.tooltip";

    public static final ItemEffect white_goety_busted_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_busted_attack");
    public static final String white_goety_busted_attack_Name = MoreModTetra.MODID + ".effect.white_goety_busted_attack.name";
    public static final String white_goety_busted_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_busted_attack.tooltip";

    public static final ItemEffect white_goety_ender_ground_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_ender_ground_attack");
    public static final String white_goety_ender_ground_attack_Name = MoreModTetra.MODID + ".effect.white_goety_ender_ground_attack.name";
    public static final String white_goety_ender_ground_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_ender_ground_attack.tooltip";

    public static final ItemEffect white_goety_plunge_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_plunge_attack");
    public static final String white_goety_plunge_attack_Name = MoreModTetra.MODID + ".effect.white_goety_plunge_attack.name";
    public static final String white_goety_plunge_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_plunge_attack.tooltip";

    public static final ItemEffect white_goety_flammable_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_flammable_attack");
    public static final String white_goety_flammable_attack_Name = MoreModTetra.MODID + ".effect.white_goety_flammable_attack.name";
    public static final String white_goety_flammable_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_flammable_attack.tooltip";

    public static final ItemEffect white_goety_wild_rage_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_wild_rage_attack");
    public static final String white_goety_wild_rage_attack_Name = MoreModTetra.MODID + ".effect.white_goety_wild_rage_attack.name";
    public static final String white_goety_wild_rage_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_wild_rage_attack.tooltip";

    public static final ItemEffect white_goety_acid_venom_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_acid_venom_attack");
    public static final String white_goety_acid_venom_attack_Name = MoreModTetra.MODID + ".effect.white_goety_acid_venom_attack.name";
    public static final String white_goety_acid_venom_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_acid_venom_attack.tooltip";

    public static final ItemEffect white_goety_tangled_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_tangled_attack");
    public static final String white_goety_tangled_attack_Name = MoreModTetra.MODID + ".effect.white_goety_tangled_attack.name";
    public static final String white_goety_tangled_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_tangled_attack.tooltip";

    public static final ItemEffect white_goety_void_touched_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_goety_void_touched_attack");
    public static final String white_goety_void_touched_attack_Name = MoreModTetra.MODID + ".effect.white_goety_void_touched_attack.name";
    public static final String white_goety_void_touched_attack_Tooltip = MoreModTetra.MODID + ".effect.white_goety_void_touched_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_3_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_3_attack");
    public static final String white_irons_spellbooks_rend_3_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_3_attack.name";
    public static final String white_irons_spellbooks_rend_3_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_3_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_4_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_4_attack");
    public static final String white_irons_spellbooks_rend_4_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_4_attack.name";
    public static final String white_irons_spellbooks_rend_4_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_4_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_5_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_5_attack");
    public static final String white_irons_spellbooks_rend_5_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_5_attack.name";
    public static final String white_irons_spellbooks_rend_5_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_5_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_6_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_6_attack");
    public static final String white_irons_spellbooks_rend_6_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_6_attack.name";
    public static final String white_irons_spellbooks_rend_6_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_6_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_7_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_7_attack");
    public static final String white_irons_spellbooks_rend_7_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_7_attack.name";
    public static final String white_irons_spellbooks_rend_7_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_7_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_8_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_8_attack");
    public static final String white_irons_spellbooks_rend_8_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_8_attack.name";
    public static final String white_irons_spellbooks_rend_8_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_8_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_9_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_9_attack");
    public static final String white_irons_spellbooks_rend_9_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_9_attack.name";
    public static final String white_irons_spellbooks_rend_9_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_9_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_10_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_10_attack");
    public static final String white_irons_spellbooks_rend_10_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_10_attack.name";
    public static final String white_irons_spellbooks_rend_10_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_10_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_11_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_11_attack");
    public static final String white_irons_spellbooks_rend_11_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_11_attack.name";
    public static final String white_irons_spellbooks_rend_11_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_11_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_12_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_12_attack");
    public static final String white_irons_spellbooks_rend_12_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_12_attack.name";
    public static final String white_irons_spellbooks_rend_12_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_12_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_rend_13_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_rend_13_attack");
    public static final String white_irons_spellbooks_rend_13_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_13_attack.name";
    public static final String white_irons_spellbooks_rend_13_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_rend_13_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_1_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_1_attack");
    public static final String white_irons_spellbooks_blight_1_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_1_attack.name";
    public static final String white_irons_spellbooks_blight_1_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_1_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_2_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_2_attack");
    public static final String white_irons_spellbooks_blight_2_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_2_attack.name";
    public static final String white_irons_spellbooks_blight_2_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_2_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_3_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_3_attack");
    public static final String white_irons_spellbooks_blight_3_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_3_attack.name";
    public static final String white_irons_spellbooks_blight_3_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_3_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_4_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_4_attack");
    public static final String white_irons_spellbooks_blight_4_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_4_attack.name";
    public static final String white_irons_spellbooks_blight_4_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_4_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_5_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_5_attack");
    public static final String white_irons_spellbooks_blight_5_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_5_attack.name";
    public static final String white_irons_spellbooks_blight_5_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_5_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_6_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_6_attack");
    public static final String white_irons_spellbooks_blight_6_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_6_attack.name";
    public static final String white_irons_spellbooks_blight_6_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_6_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_7_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_7_attack");
    public static final String white_irons_spellbooks_blight_7_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_7_attack.name";
    public static final String white_irons_spellbooks_blight_7_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_7_attack.tooltip";

    public static final ItemEffect white_irons_spellbooks_blight_8_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_irons_spellbooks_blight_8_attack");
    public static final String white_irons_spellbooks_blight_8_attack_Name = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_8_attack.name";
    public static final String white_irons_spellbooks_blight_8_attack_Tooltip = MoreModTetra.MODID + ".effect.white_irons_spellbooks_blight_8_attack.tooltip";

    public static final ItemEffect white_attributeslib_bleeding_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_attributeslib_bleeding_attack");
    public static final String white_attributeslib_bleeding_attack_Name = MoreModTetra.MODID + ".effect.white_attributeslib_bleeding_attack.name";
    public static final String white_attributeslib_bleeding_attack_Tooltip = MoreModTetra.MODID + ".effect.white_attributeslib_bleeding_attack.tooltip";

    public static final ItemEffect white_attributeslib_sundering_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_attributeslib_sundering_attack");
    public static final String white_attributeslib_sundering_attack_Name = MoreModTetra.MODID + ".effect.white_attributeslib_sundering_attack.name";
    public static final String white_attributeslib_sundering_attack_Tooltip = MoreModTetra.MODID + ".effect.white_attributeslib_sundering_attack.tooltip";

    public static final ItemEffect white_attributeslib_grievous_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_attributeslib_grievous_attack");
    public static final String white_attributeslib_grievous_attack_Name = MoreModTetra.MODID + ".effect.white_attributeslib_grievous_attack.name";
    public static final String white_attributeslib_grievous_attack_Tooltip = MoreModTetra.MODID + ".effect.white_attributeslib_grievous_attack.tooltip";

    public static final ItemEffect white_cataclysm_blazing_brand_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_cataclysm_blazing_brand_attack");
    public static final String white_cataclysm_blazing_brand_attack_Name = MoreModTetra.MODID + ".effect.white_cataclysm_blazing_brand_attack.name";
    public static final String white_cataclysm_blazing_brand_attack_Tooltip = MoreModTetra.MODID + ".effect.white_cataclysm_blazing_brand_attack.tooltip";

    public static final ItemEffect white_cataclysm_abyssal_curse_attack_Effect = ItemEffect.get(MoreModTetra.MODID + ":white_cataclysm_abyssal_curse_attack");
    public static final String white_cataclysm_abyssal_curse_attack_Name = MoreModTetra.MODID + ".effect.white_cataclysm_abyssal_curse_attack.name";
    public static final String white_cataclysm_abyssal_curse_attack_Tooltip = MoreModTetra.MODID + ".effect.white_cataclysm_abyssal_curse_attack.tooltip";

    public static final ItemEffect titan_slayer_Effect = ItemEffect.get(MoreModTetra.MODID + ":titan_slayer");
    public static final String titan_slayer_Name = MoreModTetra.MODID + ".effect.titan_slayer.name";
    public static final String titan_slayer_Tooltip = MoreModTetra.MODID + ".effect.titan_slayer.tooltip";

    public static final ItemEffect command_block_book_Effect = ItemEffect.get(MoreModTetra.MODID + ":command_block_book");
    public static final String command_block_book_Name = MoreModTetra.MODID + ".effect.command_block_book.name";
    public static final String command_block_book_Tooltip = MoreModTetra.MODID + ".effect.command_block_book.tooltip";

    public static final ItemEffect experience_edge_Effect = ItemEffect.get(MoreModTetra.MODID + ":experience_edge");
    public static final String experience_edge_Name = MoreModTetra.MODID + ".effect.experience_edge.name";
    public static final String experience_edge_Tooltip = MoreModTetra.MODID + ".effect.experience_edge.tooltip";

    public static final ItemEffect enchanting_edge_Effect = ItemEffect.get(MoreModTetra.MODID + ":enchanting_edge");
    public static final String enchanting_edge_Name = MoreModTetra.MODID + ".effect.enchanting_edge.name";
    public static final String enchanting_edge_Tooltip = MoreModTetra.MODID + ".effect.enchanting_edge.tooltip";

    public static final ItemEffect damage_buffering_Effect = ItemEffect.get(MoreModTetra.MODID + ":damage_buffering");
    public static final String damage_buffering_Name = MoreModTetra.MODID + ".effect.damage_buffering.name";
    public static final String damage_buffering_Tooltip = MoreModTetra.MODID + ".effect.damage_buffering.tooltip";
    ...
    public static final ItemEffect concept_of_guard_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_guard");
    public static final String concept_of_guard_Name = MoreModTetra.MODID + ".effect.concept_of_guard.name";
    public static final String concept_of_guard_Tooltip = MoreModTetra.MODID + ".effect.concept_of_guard.tooltip";

    public static final ItemEffect concept_of_blade_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_blade");
    public static final String concept_of_blade_Name = MoreModTetra.MODID + ".effect.concept_of_blade.name";
    public static final String concept_of_blade_Tooltip = MoreModTetra.MODID + ".effect.concept_of_blade.tooltip";

    public static final ItemEffect concept_of_sword_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_sword");
    public static final String concept_of_sword_Name = MoreModTetra.MODID + ".effect.concept_of_sword.name";
    public static final String concept_of_sword_Tooltip = MoreModTetra.MODID + ".effect.concept_of_sword.tooltip";

    public static final ItemEffect concept_of_soul_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_soul");
    public static final String concept_of_soul_Name = MoreModTetra.MODID + ".effect.concept_of_soul.name";
    public static final String concept_of_soul_Tooltip = MoreModTetra.MODID + ".effect.concept_of_soul.tooltip";

    public static final ItemEffect concept_of_life_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_life");
    public static final String concept_of_life_Name = MoreModTetra.MODID + ".effect.concept_of_life.name";
    public static final String concept_of_life_Tooltip = MoreModTetra.MODID + ".effect.concept_of_life.tooltip";

    public static final ItemEffect concept_of_element_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_element");
    public static final String concept_of_element_Name = MoreModTetra.MODID + ".effect.concept_of_element.name";
    public static final String concept_of_element_Tooltip = MoreModTetra.MODID + ".effect.concept_of_element.tooltip";

    public static final ItemEffect concept_of_substance_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_substance");
    public static final String concept_of_substance_Name = MoreModTetra.MODID + ".effect.concept_of_substance.name";
    public static final String concept_of_substance_Tooltip = MoreModTetra.MODID + ".effect.concept_of_substance.tooltip";

    public static final ItemEffect concept_of_reverse_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_reverse");
    public static final String concept_of_reverse_Name = MoreModTetra.MODID + ".effect.concept_of_reverse.name";
    public static final String concept_of_reverse_Tooltip = MoreModTetra.MODID + ".effect.concept_of_reverse.tooltip";

    public static final ItemEffect concept_of_order_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_order");
    public static final String concept_of_order_Name = MoreModTetra.MODID + ".effect.concept_of_order.name";
    public static final String concept_of_order_Tooltip = MoreModTetra.MODID + ".effect.concept_of_order.tooltip";

    public static final ItemEffect concept_of_death_Effect = ItemEffect.get(MoreModTetra.MODID + ":concept_of_death");
    public static final String concept_of_death_Name = MoreModTetra.MODID + ".effect.concept_of_death.name";
    public static final String concept_of_death_Tooltip = MoreModTetra.MODID + ".effect.concept_of_death.tooltip";

    public static final ItemEffect pure_Effect = ItemEffect.get(MoreModTetra.MODID + ":pure");
    public static final String pure_Name = MoreModTetra.MODID + ".effect.pure.name";
    public static final String pure_Tooltip = MoreModTetra.MODID + ".effect.pure.tooltip";

    public static final ItemEffect erase_Effect = ItemEffect.get(MoreModTetra.MODID + ":erase");
    public static final String erase_Name = MoreModTetra.MODID + ".effect.erase.name";
    public static final String erase_Tooltip = MoreModTetra.MODID + ".effect.erase.tooltip";

    public static final ItemEffect killaura_Effect = ItemEffect.get(MoreModTetra.MODID + ":killaura");
    public static final String killaura_Name = MoreModTetra.MODID + ".effect.killaura.name";
    public static final String killaura_Tooltip = MoreModTetra.MODID + ".effect.killaura.tooltip";

    public static final ItemEffect fake_kinetic_Effect = ItemEffect.get(MoreModTetra.MODID + ":fake_kinetic");
    public static final String fake_kinetic_Name = MoreModTetra.MODID + ".effect.fake_kinetic.name";
    public static final String fake_kinetic_Tooltip = MoreModTetra.MODID + ".effect.fake_kinetic.tooltip";
    ...
    public static boolean isWaterEntity(EntityType<?> entity) {
        return Objects.requireNonNull(ForgeRegistries.ENTITY_TYPES.tags()).getTag(
                TagKey.create(ForgeRegistries.ENTITY_TYPES.getRegistryKey(), new ResourceLocation("more_mod_tetra", "water"))
        ).contains(entity);
    }
