...
public class FireProficiency {
    ...
    public static void init() {
        var statGetter = new StatGetterEffectLevel(fireProficiencyEffect, 1);
        GuiStatBar statBar = new GuiStatBar(0, 0, StatsHelper.barLength,
                fireProficiencyName, 0, 100, false, false, false,
                statGetter, LabelGetterBasic.integerLabel,
                new TooltipGetterInteger(fireProficiencyTooltip, statGetter)
        );
