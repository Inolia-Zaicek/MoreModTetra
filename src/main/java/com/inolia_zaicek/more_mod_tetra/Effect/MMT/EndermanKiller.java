...
public class EndermanKiller {
    ...
    public static void init() {
        var statGetter = new StatGetterEffectLevel(endermanKillerEffect, 1);
        GuiStatBar statBar = new GuiStatBar(0, 0, StatsHelper.barLength,
                endermanKillerName, 0, 10, false, false, false,
                statGetter, LabelGetterBasic.integerLabel,
                new TooltipGetterInteger(endermanKillerTooltip, statGetter)
        );
