...
public class MMTManaSiphonTetraEffect {
    ...
    public static void addGuiBars() {
        IStatGetter effectStatGetter = new StatGetterEffectLevel(manaSiphon, (double)1.0F);
        GuiStatBar effectBar = new GuiStatBar(0, 0, 59, "irons_spellbooks.tetra_effect.mana_siphon", (double)0.0F, (double)30.0F, false, effectStatGetter, LabelGetterBasic.percentageLabel, new TooltipGetterPercentage("irons_spellbooks.tetra_effect.mana_siphon.tooltip", effectStatGetter));
